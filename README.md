...
## Overview
French Automation recorder enables to create programs that can be used by French Automation robots for process automation. User session is recorded as a program that can be uploaded in the orchestrator for further use.
<br/>
